...
<a><img align = "middle" src="http://fontmeme.com/embed.php?text=First-name&name=HogwartsWizard.ttf&size=20&style_color=0C0C66" alt="Harry Potter Font"></a>
</br><input align ="middle" type="text" name="first_name" value="new first-name" /><br/>

<a id="f"><img  align ="middle" src="http://fontmeme.com/embed.php?text=Last-name&name=HogwartsWizard.ttf&size=20&style_color=0C0C66" alt="Harry Potter Font"></a>
 </br><input type="text" align ="middle" name="last_name" value="new last-name"/><br />

<a id="f"><img align ="middle" src="http://fontmeme.com/embed.php?text=Email*&name=HogwartsWizard.ttf&size=20&style_color=0C0C66" alt="Harry Potter Font"></a>
</br><input align ="middle" type="text" name="email" value="new email"/><br />

<a id="f"><img  align ="middle" src="http://fontmeme.com/embed.php?text=Password*&name=HogwartsWizard.ttf&size=20&style_color=0C0C66" alt="Harry Potter Font"></a>
 </br><input  align ="middle" type="password" name="password" value="new password"/><br/>

 <a id="f"><img align ="middle" src="http://fontmeme.com/embed.php?text=Avatar&name=HogwartsWizard.ttf&size=20&style_color=0C0C66" alt="Harry Potter Font"></a>
